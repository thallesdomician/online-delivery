...
@ArgsType()
class UpdateOpeningWeekDayArgs {
  @Field(() => OpeningWeekDayWhereUniqueInput, { nullable: false })
  where!: OpeningWeekDayWhereUniqueInput;
  @Field(() => OpeningWeekDayUpdateInput, { nullable: false })
  data!: OpeningWeekDayUpdateInput;
}

export { UpdateOpeningWeekDayArgs };
